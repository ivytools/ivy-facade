...
public abstract class IvyFacadeConstants {
    ...
    public static final String ATTR_MISSING_DEPS = "missingDependencies";
    ...
    public static final String ATTR_NO_NS = "xsi:noNamespaceSchemaLocation";
    public static final String IVY_XSD = "http://ant.apache.org/ivy/schemas/ivy.xsd";
    public static final String ATTR_VERSION = "version";
    public static final String VAL_VERSION_NUM = "2.0";
}
