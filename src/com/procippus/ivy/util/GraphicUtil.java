...
public class GraphicUtil {
    ...
    private static String buildDisplayText(Module module) {
        return String.format("%s (%s)", module.getInfo().getModule(), module.getInfo().getRevision());
    }

    private static String buildDisplayText(Dependency dependency) {
        return String.format("%s (%s)", dependency.getName(), dependency.getRev());
    }
